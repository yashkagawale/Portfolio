...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "fb5bff38-c6d5-418a-8cbb-215c6e769c55");
  ...
  return (
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col lg:justify-between">
            ...
            <form 
                // action="https://getform.io/f/bronjewa" 
                onSubmit={onSubmit}
                method="POST"
                className="xl:pi-10 2xl:pl-20">
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email" 
                        required 
                        placeholder="kagawaleyash@gmail.com" 
                        className="text-field reveal-up" />
                    </div>
                </div>
